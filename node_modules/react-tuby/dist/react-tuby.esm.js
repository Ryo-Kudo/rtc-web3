...
var ClientRender = function ClientRender(_ref) {
  ...
  var _useState = useState(typeof window === "object"),
...
var ErrorBoundary = /*#__PURE__*/function (_Component) {
  ...
  function ErrorBoundary(props) {
    ...
    _this.playerRef = createRef();
    _this.videoProps = {
      crossOrigin: "anonymous",
      playsInline: true,
      controls: true,
      src: typeof _this.props.src === "string" ? _this.props.src : _this.props.src[0].url,
      children: React.createElement(React.Fragment, null, _this.props.subtitles && _this.props.subtitles.length > 0 && _this.props.subtitles.map(function (subtitle, index) {
  ...
  _proto.render = function render() {
    if (this.state.hasError) {
      ...
      }, this.props.renderer ? this.props.renderer(this.playerRef, this.videoProps) : React.createElement("video", Object.assign({
        ref: this.playerRef
      }, this.videoProps)));
    }
...
var ClickAwayListener = function ClickAwayListener(_ref) {
  ...
  return React.createElement(React.Fragment, null, children(childrenRef));
};
...
var Cog = function Cog(_ref) {
  ...
  }, others), React.createElement("path", {
...
var SettingsDialog = function SettingsDialog(_ref) {
  ...
  var _useState2 = useState("main"),
      activeSection = _useState2[0],
      setActiveSection = _useState2[1];

  var mainSectionRef = useRef(null);
  var speedSectionRef = useRef(null);
  var subtitlesSectionRef = useRef(null);
  var qualitySectionRef = useRef(null);
  var sections = {
    main: mainSectionRef,
  ...
  return React.createElement("div", {
  ...
  }, React.createElement(Speed$1, {
    className: "tuby-icon-sm"
  }), React.createElement("p", null, (internationalization == null ? void 0 : internationalization.settingsPlaybackSpeed) || "Playback Speed")), React.createElement(ChevronRight, {
    className: "tuby-chevron"
  })), subtitles && React.createElement("div", {
    onClick: function onClick() {
    ...
    className: "tuby-settings-item-left"
  }, React.createElement(SelectSubtitle, {
    className: "tuby-icon-sm"
  }), React.createElement("p", null, (internationalization == null ? void 0 : internationalization.settingsSubtitles) || "Subtitles")), React.createElement(ChevronRight, {
    style: {
      width: 15,
      height: 15
    }
  })), typeof src !== "string" && React.createElement("div", {
    onClick: function onClick() {
    ...
    className: "tuby-icon-sm"
  }), React.createElement("p", null, (internationalization == null ? void 0 : internationalization.settingsQuality) || "Quality")), React.createElement(ChevronRight, {
    className: "tuby-chevron"
  }))), React.createElement("div", {
    ref: speedSectionRef,
    ...
    className: "tuby-chevron"
  }), React.createElement("span", null, (internationalization == null ? void 0 : internationalization.settingsPlaybackSpeed) || "Playback speed")), React.createElement("div", {
    ...
    }, playbackSpeed === (index + 1) / 4 ? React.createElement(Check, {
      className: "tuby-chevron"
    }) : React.createElement("div", {
      style: {
        width: 15,
    ...
    className: "tuby-chevron"
  }), React.createElement("span", null, (internationalization == null ? void 0 : internationalization.settingsSubtitles) || "Subtitles")), React.createElement("div", {
    className: "tuby-settings-py"
  }, React.createElement("div", {
    onClick: function onClick() {
      setSubtitleIndex(-1);
    ...
    className: "tuby-settings-item-2"
  }, subtitleIndex === -1 ? React.createElement(Check, {
    className: "tuby-chevron"
  }) : React.createElement("div", {
    style: {
      width: 15,
  ...
  }), React.createElement("span", null, (internationalization == null ? void 0 : internationalization.settingsSubtitlesOff) || "Off")), subtitles.map(function (subtitle, index) {
    return React.createElement("div", {
      key: subtitle.lang,
      onClick: function onClick() {
      ...
      className: "tuby-settings-item-2"
    }, subtitleIndex === index ? React.createElement(Check, {
      className: "tuby-chevron"
    }) : React.createElement("div", {
      style: {
        width: 15,
    ...
    }), React.createElement("span", null, subtitle.language));
  }))), typeof src !== "string" && React.createElement("div", {
    ...
    className: "tuby-chevron"
  }), React.createElement("span", null, (internationalization == null ? void 0 : internationalization.settingsQuality) || "Quality")), React.createElement("div", {
    className: "tuby-settings-py"
    ...
    return React.createElement("div", {
      ...
      className: "tuby-settings-item-2"
    }, quality === index ? React.createElement(Check, {
      className: "tuby-chevron"
    }) : React.createElement("div", {
      style: {
        width: 15,
    ...
    }), React.createElement("span", null, typeof source.quality === "number" ? source.quality + "p" : source.quality));
  })))));
};
...
var SettingsModal = function SettingsModal(_ref) {
  ...
  }, React.createElement("h1", null, (internationalization == null ? void 0 : internationalization.tooltipsSettings) || "Settings"), React.createElement("div", null, React.createElement("p", null, (internationalization == null ? void 0 : internationalization.settingsPlaybackSpeed) || "Speed"), React.createElement("select", {
  ...
  }))), subtitles && React.createElement("div", null, React.createElement("p", null, (internationalization == null ? void 0 : internationalization.settingsSubtitles) || "Subtitles"), React.createElement("select", {
    value: subtitleIndex,
    onChange: function onChange(e) {
  ...
  }))), typeof src === "object" && React.createElement("div", null, React.createElement("p", null, (internationalization == null ? void 0 : internationalization.settingsQuality) || "Quality"), React.createElement("select", {
    value: quality,
    onChange: function onChange(e) {
...
var Player = function Player(_ref) {
  ...
  var _useState2 = useState(Number(localStorage.getItem("tuby-speed")) || 1),
  ...
  var _useState12 = useState(isNaN(parseInt(localStorage.getItem("tuby-volume"))) ? 100 : Number(localStorage.getItem("tuby-volume"))),
      volume = _useState12[0],
      setVolume = _useState12[1];

  var _useState13 = useState(Boolean(Number(localStorage.getItem("tuby-muted")))),
  ...
  var fullscreenToggleButton = useRef(null);
  var pauseButton = useRef(null);
  var volumeButtonRef = useRef(null);
  var subtitleButtonRef = useRef(null);
  ...
  var videoProps = {
    ...
    children: React.createElement(React.Fragment, null, subtitles && subtitles.length > 0 && subtitleIndex >= 0 && loadedData && React.createElement("track", {
      kind: "subtitles",
  ...
  return React.createElement(React.Fragment, null, poster && !pauseDidUpdate && React.createElement("img", {
    src: poster,
  ...
  }, children ? children(playerRef, videoProps) : React.createElement("video", Object.assign({
    ref: playerRef
  }, videoProps)), (!loadedData && pauseDidUpdate || loading && !paused) && React.createElement("div", {
    className: "tuby-center"
  }, React.createElement(CircularProgress, null)), paused && pauseDidUpdate && React.createElement("div", {
    className: "tuby-center",
    onClickCapture: handleScreenClicked
  }, React.createElement(PauseEffect, null)), !paused && pauseDidUpdate && React.createElement("div", {
    className: "tuby-center",
    onClickCapture: handleScreenClicked
  }, React.createElement(PlayEffect, null)), !pauseDidUpdate && React.createElement("div", {
    className: "tuby-center",
    onClickCapture: handleScreenClicked
  }, React.createElement(Play, {
    className: "tuby-icon-md"
  ...
  })), seekPreview !== null && React.createElement("div", {
  ...
  }, formatVideoTime(seekPreview.time))), React.createElement("div", {
  ...
  }, paused ? React.createElement(Play, {
    className: "tuby-icon-sm"
  }) : React.createElement(Pause, {
    className: "tuby-icon-sm"
  })), React.createElement("div", {
  ...
  }, isMuted || volume === 0 ? React.createElement(VolumeMuted, {
    className: "tuby-icon-sm"
  }) : volume === 100 ? React.createElement(VolumeFull, {
    className: "tuby-icon-sm"
  }) : React.createElement(VolumeHalf, {
    className: "tuby-icon-sm"
  })), React.createElement("div", {
    ...
    className: "tuby-time"
  }, formatVideoTime(currentTime), " / ", formatVideoTime(duration))), React.createElement("div", {
    className: "tuby-controls-right"
  }, Boolean(subtitles) && React.createElement("button", {
    ...
    return React.createElement("div", {
      ...
      className: "tuby-icon-sm"
    })), !isMobile() ? React.createElement(SettingsDialog, {
  ...
  }), pictureInPicture && ((_document2 = document) == null ? void 0 : _document2.pictureInPictureEnabled) && React.createElement("button", {
    className: "tuby-center-container",
  ...
  }, React.createElement(PictureInPicture, {
    className: "tuby-icon-sm"
  })), React.createElement("button", {
  ...
  }, onFullScreen ? React.createElement(ExitFullScreen, {
    className: "tuby-icon-sm"
...
var Player$1 = function Player$1(props) {
  ...
  }, React.createElement(ClientRender, null, React.createElement(ErrorBoundary, Object.assign({
    renderer: props.children
  }, props), React.createElement(Player, Object.assign({}, props)))));
};

export { Player$1 as Player };
